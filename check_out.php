    ...
    <div class="check_out_contain">
      ...
      <script>
        ...
        if (!isset($_SESSION['customer_email'])) {
              echo  '
              <div class="order_btn_contain_1">
                <a href="login_new.php" class="btn btn-default btn_process_ck">PROCESS ORDER </a>
              </div>';
          } else {
            echo  '
            <div class="order_btn_contain_1">
         ...
         <?php 
          // if (!isset($_SESSION['customer_email'])) {
          //     echo  '<a href="login_new.php" class="btn btn-default btn_process_ck">PROCESS ORDER </a>';
          // } else {
