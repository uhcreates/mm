...
if(isset($_GET['insert_product_colors'])){

    include("insert_product_colors.php");
    
}

if(isset($_GET['view_product_colors'])){

    include("view_product_colors.php");
...
if(isset($_GET['view_discount'])){

    include("view_discount.php");
    
}

if(isset($_GET['delete_discount'])){

    include("delete_discount.php");
    
    }
    
    if(isset($_GET['edit_discount'])){
    
    include("edit_discount.php");
