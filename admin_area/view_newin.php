...
<i class="fa fa-dashboard"></i> Dashboard / View newin
...
<i class="fa fa-money fa-fw"></i> View newin
...
<img src="new_images/<?php echo $new_img; ?>" class="img-responsive" >
...
<a href="index.php?edit_newin=<?php echo $id; ?>" class="pull-right" >
