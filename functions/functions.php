...
/// UDP
function getProductsByCartIp($id) {

global $db;
$arr = array();

$get_product_by_id = "select * from products where product_id='$id'";

$run_product_by_id = mysqli_query($db,$get_product_by_id);

while ($result_state = mysqli_fetch_array($run_product_by_id)) {
  array_push($arr, $result_state);
}
