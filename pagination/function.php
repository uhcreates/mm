   ...
   function pagination($query, $per_page = 10,$page = 1, $url = '?'){        
    	...
    	{	
    		$pagination .= "<ul class='pagination justify-content-center'>";
                    $pagination .= "<li class='page-item details' style='margin-top:2px'>Page $page of $lastpage</li>";
    		if ($lastpage < 7 + ($adjacents * 2))
    		{	
    			for ($counter = 1; $counter <= $lastpage; $counter++)
    			{
    				if ($counter == $page)
    					$pagination.= "<li class='page-item'><a class='page-link' class='current'>$counter</a></li>";
    				else
    		...
    		if ($page < $counter - 1){ 
    			...
    			$pagination.= "<li class='page-item'><a class='page-link' class='current'>Next</a></li>";
                $pagination.= "<li class='page-item'><a class='page-link' class='current'>Last</a></li>";
            }
    		$pagination.= "</ul>\n";		
    	}
